...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively
```

A live public deployment of this template is available at [https://lively.templates.workers.dev](https://lively.templates.workers.dev)
